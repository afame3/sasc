...
INSERT INTO `cotizacion` (`idcotizacion`,`numero_cotizacion`,`estado_cotizacion`,`empresa_idempresa`,`empleado_idempleado`,`descripcion_cotizacion`,`fecha_cotizacion`,`observacion_cotizacion`) VALUES 
 (1,'1','Rechazada',1,1,NULL,NULL,NULL),
 (2,'2','Aprobada',2,2,NULL,NULL,NULL),
 (3,'3','Pendiente',3,3,NULL,NULL,NULL),
 (4,'4','Aprobada',1,1,'prueba',NULL,NULL),
 (5,'5','Pendiente',2,2,'prueba2',NULL,NULL),
 (6,'6','Pendiente',3,3,'mensaje',NULL,NULL),
 (7,'7','Pendiente',1,1,'descripcion',NULL,NULL),
 (8,'9','Pendiente',1,2,'dsfdsfdfd',NULL,NULL),
 (9,'10','Pendiente',2,3,'prueba',NULL,NULL),
 (10,'11','Pendiente',2,3,'prueba',NULL,NULL),
 (11,'12','Pendiente',3,2,'CotizaciÃ³n numero2',NULL,NULL),
 (12,'123','Pendiente',15,1,'cotizacion nro1',NULL,NULL),
 (13,'200','Pendiente',15,6,'esta pendiente enviar cotizacion','2019-10-15 00:00:00',NULL),
 (14,'201','Pendiente',5,6,'higiene ocupacional','2019-10-15 00:00:00',NULL),
 (15,'202','Pendiente',1,5,'descripcion 1','2019-10-15 00:00:00','descripcion 1'),
 (16,'203','Pendiente',3,4,'prueba monitoreo','2019-10-15 00:00:00','cotizacion pendiente');
...
INSERT INTO `empresa` (`idempresa`,`numero_empresa`,`razon_social`,`ruc`,`estado_empresa`,`direccion_empresa`,`telefono_empresa`,`contacto_empres`) VALUES 
 (1,1,'Head Systems','20482383514','1','C. Elias Ascuez 143, Urb. El Bosque, Rimac, Lima','971430728',NULL),
 (2,2,'culturaq_sistema QQSE',NULL,'1',NULL,NULL,NULL),
 (3,3,'SaneIndustrial',NULL,'1',NULL,NULL,NULL),
 (4,4,'ABC','20222222222','Activo','direcion 1','89898098',NULL),
 (5,8,'empres 1','28282828282','Activo','direcion 2','4444444',NULL),
 (6,11,'razon 1','3493939393','Activo','direccion 3','444444',NULL),
 (7,12,'12','12','Activo','12','12',NULL),
 (8,13,'13','13','Activo','13','12',NULL),
 (9,14,'14','14','Activo','14','14',NULL),
 (10,18,'18','18','Activo','18','18',NULL),
 (11,10,'10','10','Activo','10','10',NULL),
 (12,22,'22','22','Activo','22','22',NULL),
 (13,33,'33','33','Activo','33','33',NULL),
 (14,21,'21','21','Activo','21','21',NULL),
 (15,NULL,'sole','2322','Activo','','',NULL);
