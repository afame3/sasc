...
INSERT INTO `cotizacion` (`idcotizacion`,`numero_cotizacion`,`estado_cotizacion`,`empresa_idempresa`,`empleado_idempleado`,`descripcion_cotizacion`,`fecha_cotizacion`) VALUES 
 (1,'1','Rechazada',1,1,NULL,NULL),
 (2,'2','Aprobada',2,2,NULL,NULL),
 (3,'3','Pendiente',3,3,NULL,NULL),
 (4,'4','Aprobada',1,1,'prueba',NULL),
 (5,'5','Pendiente',2,2,'prueba2',NULL),
 (6,'6','Pendiente',3,3,'mensaje',NULL),
 (7,'7','Pendiente',1,1,'descripcion',NULL),
 (8,'9','Pendiente',1,2,'dsfdsfdfd',NULL),
 (9,'10','Pendiente',2,3,'prueba',NULL),
 (10,'11','Pendiente',2,3,'prueba',NULL),
 (11,'12','Pendiente',3,2,'CotizaciÃ³n numero2',NULL);
...
INSERT INTO `empresa` (`idempresa`,`numero_empresa`,`razon_social`,`ruc`,`estado_empresa`,`direccion_empresa`,`telefono_empresa`) VALUES 
 ...
 (2,2,'culturaq_sistema QQSE',NULL,'1',NULL,NULL),
